<x-layout
    title="Reportes Gerenciales con Power BI Bolivia | Dashboards Financieros | Otium"
    description="Convertimos tu contabilidad en dashboards de Power BI para que tomes decisiones con datos reales. Bolivia — Santa Cruz y La Paz."
>
    <!-- Hero Section -->
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-3xl text-left">
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight" data-aos="fade-up">
                    {{ __('Dashboards y reportes gerenciales') }}<span class="text-primary"> {{ __('que tu empresa entiende') }}</span>
                </h1>
                <p class="text-xl md:text-2xl text-white/90 mb-10 leading-relaxed font-light" data-aos="fade-up" data-aos-delay="100">
                    {{ __('¿Tus datos están en diez archivos distintos y nadie los entiende en una reunión de directorio?') }}
                </p>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="w-full md:w-1/2" data-aos="fade-right">
                    <div class="relative">
                        <div class="absolute inset-0 bg-purple-50 rounded-2xl transform translate-x-4 translate-y-4"></div>
                        <img src="/images/otium/carousel/transformacion_digital.png" alt="Dashboard Power BI"
                            class="relative rounded-2xl shadow-xl w-full h-100 object-cover">
                    </div>
                </div>
                <div class="w-full md:w-1/2" data-aos="fade-left">
                    <span class="text-primary font-bold tracking-wider uppercase text-sm mb-2 block">Power BI & Analytics</span>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">{{ __('De datos dispersos a visión ejecutiva') }}</h2>
                    <p class="text-gray-600 text-lg leading-relaxed mb-6">
                        Tomamos datos de tu ERP, Excel, banco o cualquier fuente y los transformamos en un dashboard interactivo actualizado mensualmente — listo para tu reunión de directorio.
                    </p>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        En <strong class="text-secondary">OTIUM</strong> nos encargamos del diseño, la conexión de datos y la capacitación. Sin necesidad de un equipo de TI interno.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-gray-900 text-center mb-16" data-aos="fade-up">{{ __('Por qué elegir nuestros Dashboards') }}</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary" data-aos="fade-up">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">{{ __('KPIs en tiempo real') }}</h3>
                    <p class="text-gray-600">Ventas, costos, rentabilidad y liquidez visibles en una sola pantalla actualizada.</p>
                </div>
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">{{ __('Conexión de múltiples fuentes') }}</h3>
                    <p class="text-gray-600">Integramos SAP, Odoo, Excel, SQL y más en un único modelo de datos coherente.</p>
                </div>
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">{{ __('Actualización automática') }}</h3>
                    <p class="text-gray-600">El dashboard se actualiza solo, sin enviar archivos manualmente cada mes.</p>
                </div>
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">{{ __('Acceso desde cualquier dispositivo') }}</h3>
                    <p class="text-gray-600">Consulta tu información desde celular, tablet o computadora en cualquier momento.</p>
                </div>
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">{{ __('Reportes personalizados por área') }}</h3>
                    <p class="text-gray-600">Dashboards distintos para gerencia, finanzas, ventas y operaciones según lo que cada área necesita ver.</p>
                </div>
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">{{ __('Capacitación incluida') }}</h3>
                    <p class="text-gray-600">Entrenamos a tu equipo para interpretar y usar el dashboard de forma autónoma.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-gray-900 text-center mb-16" data-aos="fade-up">{{ __('¿Qué incluye nuestro servicio?') }}</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="flex gap-4" data-aos="fade-right">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-1">Dashboard financiero mensual</h4>
                        <p class="text-gray-600">Reporte visual actualizado con los KPIs más importantes para la toma de decisiones ejecutivas.</p>
                    </div>
                </div>
                <div class="flex gap-4" data-aos="fade-left">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-1">KPIs por área: ventas, costos, tesorería, tributario</h4>
                        <p class="text-gray-600">Indicadores diferenciados por área para que cada gerente vea exactamente lo que necesita.</p>
                    </div>
                </div>
                <div class="flex gap-4" data-aos="fade-right">
                    <div class="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center text-teal-700 shrink-0">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-1">Integración con SAP, Odoo o Excel existente</h4>
                        <p class="text-gray-600">Conectamos Power BI con tu sistema actual sin necesidad de migrar datos ni cambiar herramientas.</p>
                    </div>
                </div>
                <div class="flex gap-4" data-aos="fade-left">
                    <div class="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center text-teal-700 shrink-0">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-1">Acceso en tiempo real desde cualquier dispositivo</h4>
                        <p class="text-gray-600">Consulta tu dashboard desde celular, tablet o computadora con acceso seguro por usuario.</p>
                    </div>
                </div>
                <div class="flex gap-4" data-aos="fade-right">
                    <div class="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center text-teal-700 shrink-0">
                    ...
                    <div>
                        <h4 class="text-xl font-bold text-gray-900 mb-1">Capacitación para el equipo gerencial</h4>
                        <p class="text-gray-600">Entrenamiento para que tu equipo interprete y use el dashboard con autonomía desde el primer mes.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-secondary text-white">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-center mb-16" data-aos="fade-up">{{ __('Nuestro Proceso de Trabajo') }}</h2>
            <div class="grid grid-cols-1 md:grid-cols-5 gap-8 text-center relative">
                ...
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <h3 class="font-bold text-xl mb-2">{{ __('Relevamiento') }}</h3>
                    <p class="text-sm text-white/80">Identificamos fuentes de datos, KPIs y necesidades del equipo.</p>
                </div>
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="font-bold text-xl mb-2">{{ __('Diseño') }}</h3>
                    <p class="text-sm text-white/80">Prototipo del dashboard y validación con el cliente.</p>
                </div>
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h3 class="font-bold text-xl mb-2">{{ __('Desarrollo') }}</h3>
                    <p class="text-sm text-white/80">Conexión de datos, modelo y construcción del informe.</p>
                </div>
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <h3 class="font-bold text-xl mb-2">{{ __('Publicación') }}</h3>
                    <p class="text-sm text-white/80">Despliegue en Power BI Service y configuración de accesos.</p>
                </div>
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <h3 class="font-bold text-xl mb-2">{{ __('Mantenimiento') }}</h3>
                    <p class="text-sm text-white/80">Actualización mensual y mejoras según necesidades del negocio.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="space-y-4" x-data="{ active: null }">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <button @click="active = (active === 1 ? null : 1)" class="w-full px-6 py-4 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors">
                        <span class="font-bold text-gray-900">¿Necesito tener Power BI instalado?</span>
                    ...
                    <div x-show="active === 1" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        No. Los dashboards se publican en Power BI Service (web) y se acceden desde cualquier navegador. Solo necesitas una licencia de Microsoft 365, que podemos ayudarte a gestionar.
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <button @click="active = (active === 2 ? null : 2)" class="w-full px-6 py-4 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors">
                        <span class="font-bold text-gray-900">¿Con qué sistemas pueden conectar los datos?</span>
                    ...
                    <div x-show="active === 2" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        Power BI se conecta con cientos de fuentes: Excel, SQL Server, SAP, Odoo, Google Sheets, bases de datos locales y APIs. Si tienes los datos, podemos conectarlos.
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <button @click="active = (active === 3 ? null : 3)" class="w-full px-6 py-4 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors">
                        <span class="font-bold text-gray-900">¿Cuánto tiempo toma implementar el primer dashboard?</span>
                    ...
                    <div x-show="active === 3" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        El primer dashboard gerencial normalmente está listo en 2 a 4 semanas, dependiendo de la complejidad de las fuentes de datos y la cantidad de indicadores requeridos.
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <button @click="active = (active === 4 ? null : 4)" class="w-full px-6 py-4 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors">
                        <span class="font-bold text-gray-900">¿Podemos modificar el dashboard después?</span>
                    ...
                    <div x-show="active === 4" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        Sí. Los dashboards evolucionan con tu negocio. Incluimos un número de modificaciones mensuales y ajustamos indicadores según cambien las prioridades de tu empresa.
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <button @click="active = (active === 5 ? null : 5)" class="w-full px-6 py-4 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors">
                        <span class="font-bold text-gray-900">¿Mis datos están seguros en la nube?</span>
                    ...
                    <div x-show="active === 5" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        Power BI Service usa la infraestructura segura de Microsoft Azure con encriptación en tránsito y en reposo. Configuramos permisos de acceso por usuario para garantizar confidencialidad.
                    </div>
                </div>
            </div>
        </div>
