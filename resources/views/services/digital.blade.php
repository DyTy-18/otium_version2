<x-layout
    title="Transformación Digital e Inteligencia de Negocios"
    description="Digitaliza y automatiza tu empresa con OTIUM: dashboards Power BI, Cloud Computing, integración SAP/Odoo con Microsoft 365 en Bolivia."
>
    <!-- Hero Section -->
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="w-full md:w-1/2" data-aos="fade-right">
                    <div class="relative">
                        ...
                        <img src="/images/otium/carousel/transformacion_digital.png" alt="Eficiencia y Modernidad"
