<x-layout>
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-3xl text-left">
                ...
                <p class="text-xl md:text-2xl text-white/90 mb-10 leading-relaxed font-light" data-aos="fade-up"
                    data-aos-delay="100">
                    ¿Estás destinando demasiado tiempo y recursos a tareas contables?
                </p>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row items-center gap-12">
                ...
                <div class="w-full md:w-1/2" data-aos="fade-left">
                    <span class="text-primary font-bold tracking-wider uppercase text-sm mb-2 block">Outsourcing
                        Contable</span>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Tu Departamento Contable Externo</h2>
                    <p class="text-gray-600 text-lg leading-relaxed mb-6">
                        Nuestro servicio de outsourcing contable te permite delegar en expertos todas esas
                        responsabilidades administrativas y financieras.
                    </p>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        En <strong class="text-secondary">OTIUM</strong> nos convertimos en tu aliado estratégico:
                        llevamos tus libros al día, gestionamos tus obligaciones tributarias y laborales, y te
                        entregamos información financiera confiable para que tomes decisiones con tranquilidad.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-gray-900 text-center mb-16" data-aos="fade-up">Por qué elegir nuestro
                Outsourcing</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary"
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Análisis Financiero</h3>
                    <p class="text-gray-600">Información clara y oportuna para entender la salud de tu empresa.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary"
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Enfoque en tu negocio</h3>
                    <p class="text-gray-600">Concéntrate en generar valor mientras nosotros nos ocupamos de los números
                        operativos.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary"
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Cumplimiento garantizado</h3>
                    <p class="text-gray-600">Evita multas y retrasos. Cumplimos normas contables, tributarias y
                ...
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary"
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Expertos a tu servicio</h3>
                    <p class="text-gray-600">Equipo profesional con experiencia sin el costo fijo de personal interno.
                    </p>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary"
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Tecnología y eficiencia</h3>
                    <p class="text-gray-600">Plataformas modernas y en la nube. Acceso seguro y en tiempo real a tus
                        datos.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-t-4 border-primary"
                    ...
                    <p class="text-gray-600">Nos adaptamos a tu crecimiento. Gestionamos mayor volumen manteniendo la
                        calidad.</p>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-gray-900 text-center mb-16" data-aos="fade-up">¿Qué incluye nuestro
                servicio?</h2>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-8 text-center relative">
                ...
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer"
                    ...
                    <p class="text-sm text-white/80">Revisión de situación contable, fiscal y necesidades.</p>
                </div>
                ...
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer"
                    ...
                    <p class="text-sm text-white/80">Definición de alcance y configuración de plataformas.</p>
                </div>
                ...
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer"
                    ...
                    <p class="text-sm text-white/80">Registro, conciliaciones, impuestos y estados.</p>
                </div>
                ...
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer"
                    ...
                    <p class="text-sm text-white/80">Entrega de reportes y reuniones de resultados.</p>
                </div>
                ...
                <div class="relative z-10 transition-transform duration-300 hover:-translate-y-2 hover:scale-105 cursor-pointer"
                    ...
                    <div
                        class="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6 shadow-lg border-4 border-secondary">
                        5</div>
                    <h3 class="font-bold text-xl mb-2">Mejora</h3>
                    <p class="text-sm text-white/80">Ajustes continuos según tu crecimiento.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="space-y-4" x-data="{ active: null }">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <button @click="active = (active === 1 ? null : 1)"
                        ...
                        <span class="font-bold text-gray-900">¿Por qué debería externalizar mi contabilidad?</span>
                    ...
                    <div x-show="active === 1" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        Externalizar te permite ahorrar tiempo y costos. Accedes a especialistas, reduces errores,
                        garantizas cumplimiento y liberas tiempo para enfocarte en tu estrategia de negocio.
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <button @click="active = (active === 2 ? null : 2)"
                        class="w-full px-6 py-4 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors">
                        <span class="font-bold text-gray-900">¿Cómo se protege la confidencialidad de mi
                            información?</span>
                    ...
                    <div x-show="active === 2" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        Usamos sistemas seguros, encriptación y firmamos acuerdos de confidencialidad estrictos para
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <button @click="active = (active === 3 ? null : 3)"
                        class="w-full px-6 py-4 text-left flex justify-between items-center bg-gray-50 hover:bg-gray-100 transition-colors">
                        <span class="font-bold text-gray-900">¿Mi empresa es muy grande/pequeña para este
                            servicio?</span>
                    ...
                    <div x-show="active === 3" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        Atendemos desde empresas en crecimiento hasta grandes corporaciones. Escalamos recursos según
                        tus necesidades y volumen de operaciones.
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="active === 4" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        Podemos complementarlo. Nos encargamos de tareas operativas o especializadas, liberándolo para
                        roles más analíticos y estratégicos.
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div x-show="active === 5" class="px-6 py-4 text-gray-600 border-t border-gray-100" x-transition>
                        Contáctanos para una reunión. Haremos un diagnóstico gratuito, presentamos una propuesta, e
                        iniciamos la integración de inmediato al aceptar.
                    </div>
                </div>
            </div>
        </div>
