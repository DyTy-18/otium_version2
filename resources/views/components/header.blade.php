    ...
    <div class="container mx-auto px-6 flex justify-between items-center relative z-50">
        ...
        <nav class="hidden md:flex gap-8 items-center font-medium transition-colors duration-300"
            ...
            <a href="{{ route('doing-business') }}"
                class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-semibold border border-accent/40 text-accent hover:bg-accent hover:text-white hover:border-accent transition-all duration-200 {{ request()->routeIs('doing-business') ? 'bg-accent text-white border-accent' : '' }}">
