    ...
    <form method="POST" action="{{ route('admin.posts.update', $post) }}" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                {{-- Popup de entrada --}}
                <div class="bg-white rounded-xl shadow-sm p-6"
                     x-data="popupCard(@js(['initEnabled' => (bool) old('popup_enabled', $post->popup_enabled), 'initTitle' => old('title', $post->title), 'initExcerpt' => old('excerpt', $post->excerpt ?? ''), 'initHasDocument' => (bool) $post->document_path]))"
